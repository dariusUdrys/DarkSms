    ...
    def lookUp():
        ...
        while True:
            ...
            try:
                ...
                time.sleep(0.5)
                ipCheck =requests.get(ip_url ,proxies ={"http":proxy ,"https":proxy },timeout =3)
                print(f"\033[34;1m[\033[32m+\033[34m] \033[37mValid Proxy Address: \033[32m{ipCheck.text}\033[0m")
                for i in range(15):
